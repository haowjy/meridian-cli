...
_OP_SPECS: tuple[ExtensionCommandSpec, ...] = (
    ...
    ExtensionCommandSpec.from_op(
        extension_id="meridian.work",
        command_id="worktree",
        summary="Show or ensure worktree state for an active or explicit work item.",
        handler=work_worktree,
        sync_handler=work_worktree_sync,
        input_type=WorkWorktreeInput,
        output_type=WorkWorktreeOutput,
        cli_group="work",
        cli_name="worktree",
        agent_default_format="text",
        surfaces=frozenset({ExtensionSurface.CLI, ExtensionSurface.HTTP}),
    ...
    ExtensionCommandSpec.from_op(
        extension_id="meridian.work",
        command_id="set-worktree",
        summary="Assign an existing directory as a work item's worktree path.",
        handler=work_set_worktree,
        sync_handler=work_set_worktree_sync,
        input_type=WorkSetWorktreeInput,
        output_type=WorkSetWorktreeOutput,
        cli_group="work",
        cli_name="set-worktree",
        agent_default_format="text",
        surfaces=frozenset({ExtensionSurface.CLI, ExtensionSurface.HTTP}),
    ),
    ExtensionCommandSpec.from_op(
        extension_id="meridian.work",
        command_id="clear-worktree",
        summary="Clear a work item's stored worktree path assignment.",
        handler=work_clear_worktree,
        sync_handler=work_clear_worktree_sync,
        input_type=WorkClearWorktreeInput,
        output_type=WorkClearWorktreeOutput,
        cli_group="work",
        cli_name="clear-worktree",
        agent_default_format="text",
        surfaces=frozenset({ExtensionSurface.CLI, ExtensionSurface.HTTP}),
    ),
    ExtensionCommandSpec.from_op(
