...
_OP_SPECS: tuple[ExtensionCommandSpec, ...] = (
    ...
    ExtensionCommandSpec.from_op(
        extension_id="meridian",
        command_id="task-dir",
        summary="Print the current process effective source-edit directory.",
        handler=task_dir,
        sync_handler=task_dir_sync,
        input_type=TaskDirInput,
        output_type=TaskDirOutput,
        cli_group=None,
        cli_name=None,
        surfaces=frozenset({ExtensionSurface.CLI}),
    ),
    ExtensionCommandSpec.from_op(
        extension_id="meridian.task-dir",
        command_id="set",
        summary="Set spawn-scope source-edit directory for this session.",
        handler=task_dir_set,
        sync_handler=task_dir_set_sync,
        input_type=TaskDirSetInput,
        output_type=TaskDirMutationOutput,
        cli_group="task-dir",
        cli_name="set",
        surfaces=frozenset({ExtensionSurface.CLI}),
    ),
    ExtensionCommandSpec.from_op(
        extension_id="meridian.task-dir",
        command_id="clear",
        summary="Clear spawn-scope source-edit directory override for this session.",
        handler=task_dir_clear,
        sync_handler=task_dir_clear_sync,
        input_type=TaskDirClearInput,
        output_type=TaskDirMutationOutput,
        cli_group="task-dir",
        cli_name="clear",
        surfaces=frozenset({ExtensionSurface.CLI}),
    ...
    ExtensionCommandSpec.from_op(
        ...
        command_id="subagents",
        summary="List subagents the current agent may spawn.",
        handler=spawn_subagents,
        sync_handler=spawn_subagents_sync,
        input_type=SpawnSubagentsInput,
        output_type=SpawnSubagentsOutput,
        cli_group="spawn",
        cli_name="subagents",
        surfaces=frozenset({ExtensionSurface.CLI}),
    ),
