...
def _scaffold_template() -> str:
    ...
    sections: tuple[tuple[str, ...], ...] = (
        (
            ...
            "# Harnesses blocked from headless `meridian spawn` so delegation prefers",
            "# native subagents (e.g. Claude's Agent tool). Set to [] to allow.",
            ...
            '# model = ""',
            "# Harness override for the primary agent.",
            '# harness = ""',
