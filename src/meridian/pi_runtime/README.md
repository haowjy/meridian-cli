...
- `dist/extensions/session-boundary/index.js` — bounded native RPC session-shutdown observation (identity-qualified launches only)
...
npm run build:extensions:verify-source # rebuild and require source-built boundary artifact
