"""Integration tests for meridian.lib.ops.qi — inline knowledge navigation.

Classified integration: discover_knowledge_points and related functions do
real directory traversal using tmp_path (real filesystem I/O). Moved from
tests/unit/.
